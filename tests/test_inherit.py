...
def test_inherit_value_with_multi_parts_path():
    data = {"key1": "value1"}
...
def test_inherit_value_in_list_of_dict():
    data = [
        {"key1": "value1"},
        {"key1": "value1"},
    ]
...
def test_inherit_value_with_star_notation():
    data = {
        "dev": {"key1": "dev_value1"},
...
def test_inherit_value_edge_cases():
    data = {"key1": "value1"}
    ...
    with pytest.raises(TypeError):
        inherit_value(
            path="k1.k11.k111", value="v111", data={"k1": {"k11": "v11"}}
        )


def test_inherit_value_edge_cases_missing_keys():
    ...
    data = {"envs": [{"name": "dev"}, {"name": "prod"}]}
    with pytest.raises(KeyError):
        inherit_value(path="envs.missing_key.field", value="value", data=data)


def test_inherit_value_empty_data_structures():
...
def test_inherit_value_star_with_shared_key():
...
def test_apply_inheritance_edge_cases():
    ...
    data = {"dev": {"key": "value"}, "prod": {"key": "value"}}
    original = data.copy()
    apply_inheritance(data)
...
def test_apply_inheritance_with_nested_lists():
